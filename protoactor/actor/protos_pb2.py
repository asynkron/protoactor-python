...
PoisonPill = _reflection.GeneratedProtocolMessageType('PoisonPill', (_message.Message,), {
...
Watch = _reflection.GeneratedProtocolMessageType('Watch', (_message.Message,), {
  'DESCRIPTOR' : _WATCH,
  '__module__' : 'protoactor.actor.protos_pb2'
...
Unwatch = _reflection.GeneratedProtocolMessageType('Unwatch', (_message.Message,), {
  'DESCRIPTOR' : _UNWATCH,
  '__module__' : 'protoactor.actor.protos_pb2'
